...
const createInvalidRequestBucket_js_1 = require("./createInvalidRequestBucket.js");
...
function createRestManager(options) {
    const version = options.version || constants_js_1.API_VERSION;
    if (options.customUrl) {
        constants_js_1.baseEndpoints.BASE_URL = `${options.customUrl}/v${version}`;
    }
    const rest = {
        invalidBucket: (0, createInvalidRequestBucket_js_1.createInvalidRequestBucket)({}),
        version,
        ...
        processRateLimitedPaths: options.processRateLimitedPaths ||
            processRateLimitedPaths_js_1.processRateLimitedPaths,
        processRequestHeaders: options.processRequestHeaders ||
            processRequestHeaders_js_1.processRequestHeaders,

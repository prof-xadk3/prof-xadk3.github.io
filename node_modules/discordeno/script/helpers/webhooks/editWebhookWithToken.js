 ...
 */
async function editWebhookWithToken(bot, webhookId, token, options) {
    const result = await bot.rest.runMethod(bot.rest, "PATCH", bot.constants.routes.WEBHOOK(webhookId, token), {
        name: options.name,

...
exports.editOriginalInteractionResponse = void 0;
 ...
 */
async function editOriginalInteractionResponse(bot, token, options) {
    const result = await bot.rest.runMethod(bot.rest, "PATCH", bot.constants.routes.INTERACTION_ORIGINAL_ID_TOKEN(bot.applicationId, token), {
        ...bot.transformers.reverse.interactionResponse(bot, {
            type: mod_js_1.InteractionResponseTypes.UpdateMessage,
            data: options,
        }).data,
        file: options.file,
    });

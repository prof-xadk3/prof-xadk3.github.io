 ...
 */
async function editBotMember(bot, guildId, options) {
    const result = await bot.rest.runMethod(bot.rest, "PATCH", bot.constants.routes.USER_NICK(guildId), {
        nick: options.nick,
        reason: options.reason,
    });
    return bot.transformers.member(bot, result, bot.transformers.snowflake(guildId), bot.id);
}
exports.editBotMember = editBotMember;

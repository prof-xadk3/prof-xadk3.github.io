...
exports.createGlobalApplicationCommand = void 0;
const deps_js_1 = require("../../../deps.js");
const applicationCommandLength_js_1 = require("../../applicationCommandLength.js");
const applicationCommandOptions_js_1 = require("../../applicationCommandOptions.js");
function createGlobalApplicationCommand(bot) {
    ...
    bot.helpers.createGlobalApplicationCommand = async function (options) {
        ...
        if (isChatInput) {
            ...
            (0, applicationCommandLength_js_1.validateApplicationCommandLength)(options);
        }
        else {

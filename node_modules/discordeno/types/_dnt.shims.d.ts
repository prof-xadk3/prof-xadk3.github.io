...
export { default as WebSocket, type CloseEvent, type MessageEvent } from "ws";
export declare const dntGlobalThis: Omit<typeof globalThis, "setTimeout" | "setInterval" | "Deno" | "Blob" | "fetch" | "File" | "FormData" | "Headers" | "Request" | "Response" | "WebSocket"> & {
    Deno: typeof Deno;
    Blob: typeof Blob;

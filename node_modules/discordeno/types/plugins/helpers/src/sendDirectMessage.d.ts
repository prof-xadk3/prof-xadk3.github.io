...
export declare const dmChannelIds: Collection<BigString, BigString>;
...
export declare function sendDirectMessage(bot: Bot, userId: BigString, content: string | CreateMessage): Promise<import("../deps.js").Message>;

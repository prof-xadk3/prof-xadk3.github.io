...
export declare function transformTemplate(bot: Bot, payload: DiscordTemplate): {
    ...
    serializedSourceGuild: {
        ...
        channels?: {
            ...
            default_sort_order?: import("../types/shared.js").SortOrderTypes | null | undefined;
            id: string;
            type: import("../types/shared.js").ChannelTypes;
            available_tags: import("../types/discord.js").DiscordForumTag[];
            applied_tags: string[];
        ...
        name: string;
        roles: (Omit<import("../types/shared.js").PickPartial<import("../types/discord.js").DiscordRole, "name" | "permissions" | "color" | "hoist" | "mentionable" | "icon" | "unicode_emoji">, "id"> & {
            id: number;
        })[];

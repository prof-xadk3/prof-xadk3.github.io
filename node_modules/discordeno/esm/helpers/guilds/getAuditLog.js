 ...
 */
export async function getAuditLog(bot, guildId, options) {
    if (options?.limit) {
    ...
    return {
        ...
        applicationCommands: result.application_commands.map((applicationCommand) => bot.transformers.applicationCommand(bot, applicationCommand)),
    };
}

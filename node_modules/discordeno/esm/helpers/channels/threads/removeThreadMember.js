 ...
 */
export async function removeThreadMember(bot, channelId, userId) {
    return await bot.rest.runMethod(bot.rest, "DELETE", bot.constants.routes.THREAD_USER(channelId, userId));
}

 ...
 */
export async function getPrivateJoinedArchivedThreads(bot, channelId, options) {
    const results = await bot.rest.runMethod(bot.rest, "GET", bot.constants.routes.THREAD_ARCHIVED_PRIVATE_JOINED(channelId, options));
    return {

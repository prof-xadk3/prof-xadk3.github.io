 ...
 */
export async function removeRole(bot, guildId, userId, roleId, reason) {
    return await bot.rest.runMethod(bot.rest, "DELETE", bot.constants.routes.GUILD_MEMBER_ROLE(guildId, userId, roleId), { reason });
}

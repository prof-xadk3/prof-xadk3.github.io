 ...
 */
export async function deleteOriginalInteractionResponse(bot, token) {
    return await bot.rest.runMethod(bot.rest, "DELETE", bot.constants.routes.INTERACTION_ORIGINAL_ID_TOKEN(bot.applicationId, token));
}

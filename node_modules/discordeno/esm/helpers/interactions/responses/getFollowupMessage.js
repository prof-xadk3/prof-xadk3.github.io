 ...
 */
export async function getFollowupMessage(bot, token, messageId) {
    const result = await bot.rest.runMethod(bot.rest, "GET", bot.constants.routes.INTERACTION_ID_TOKEN_MESSAGE_ID(bot.applicationId, token, messageId));

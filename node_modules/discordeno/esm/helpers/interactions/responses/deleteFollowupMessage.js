 ...
 */
export async function deleteFollowupMessage(bot, token, messageId) {
    return await bot.rest.runMethod(bot.rest, "DELETE", bot.constants.routes.INTERACTION_ID_TOKEN_MESSAGE_ID(bot.applicationId, token, messageId));
}

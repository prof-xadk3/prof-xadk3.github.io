 ...
 */
export async function crosspostMessage(bot, channelId, messageId) {
    const result = await bot.rest.runMethod(bot.rest, "POST", bot.constants.routes.CHANNEL_MESSAGE_CROSSPOST(channelId, messageId));

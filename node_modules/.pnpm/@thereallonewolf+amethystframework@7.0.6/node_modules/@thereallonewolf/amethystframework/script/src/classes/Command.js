...
class CommandClass {
    ...
    toApplicationCommand() {
        ...
        (0, Validations_js_1.validateRequiredParameters)(this.name, this.description, this.args?.length
            ? this.args.map((e) => {
                return {
                    ...e,
                    description: e.description ?? "A slash command option",
                    channelTypes: e.channelTypes?.map((f) => typeof f == "string" ? deps_js_1.ChannelTypes[f] : f),
                    type: typeof e.type == "number"
                        ? e.type
                        : deps_js_1.ApplicationCommandOptionTypes[e.type],
                };
            })
            : []);
        return {

...
const index = require('./index-15416fc7.js');
...
const patchBrowser = () => {
    ...
    }
    {
        ...
        if (!index.win.customElements) {
            ...
            // @ts-ignore
            return Promise.resolve().then(function () { return require(/* webpackChunkName: "polyfills-dom" */ './dom-be1edfde.js'); }).then(() => opts);
        }
    }
...
patchBrowser().then(options => {
  return index.bootstrapLazy([["data-table.cjs",[[0,"data-table",{"uniqueID":[1025,"unique-i-d"],"isCompact":[1028,"is-compact"],"hideDataTable":[1028,"hide-data-table"],"margin":[1040],"padding":[1040],"tableColumns":[1040],"secondaryTableColumns":[1040],"dataKeyNames":[1040],"data":[16],"secondaryData":[16],"unitTest":[1028,"unit-test"],"showTable":[32]}]]]], options);
});

...
import { CreateApplicationCommand } from "../../../types/mod.js";
 ...
 */
export declare function upsertGlobalApplicationCommands(bot: Bot, commands: CreateApplicationCommand[]): Promise<Collection<bigint, ApplicationCommand>>;

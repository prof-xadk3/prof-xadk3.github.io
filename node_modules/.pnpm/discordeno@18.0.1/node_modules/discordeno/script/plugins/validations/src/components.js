    ...
    for (const component of components) {
        ...
        if (component.components?.length > 5)
            ...
            component.components.some((subComponent) => subComponent.type === deps_js_1.MessageComponentTypes.SelectMenu ||
                subComponent.type === deps_js_1.MessageComponentTypes.SelectMenuChannels ||
                subComponent.type === deps_js_1.MessageComponentTypes.SelectMenuRoles ||
                subComponent.type === deps_js_1.MessageComponentTypes.SelectMenuUsers ||
                subComponent.type === deps_js_1.MessageComponentTypes.SelectMenuUsersAndRoles)) {

 ...
 */
async function createGlobalApplicationCommand(bot, command) {
    const result = await bot.rest.runMethod(bot.rest, "POST", bot.constants.routes.COMMANDS(bot.applicationId), bot.transformers.reverse.createApplicationCommand(bot, command));

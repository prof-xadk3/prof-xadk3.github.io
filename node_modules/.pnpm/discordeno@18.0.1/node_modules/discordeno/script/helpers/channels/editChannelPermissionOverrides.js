 ...
 */
async function editChannelPermissionOverrides(bot, channelId, options) {
    return await bot.rest.runMethod(bot.rest, "PUT", bot.constants.routes.CHANNEL_OVERWRITE(channelId, options.id), {

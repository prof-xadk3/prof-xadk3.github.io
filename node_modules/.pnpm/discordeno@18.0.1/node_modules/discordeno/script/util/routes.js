...
const mod_js_1 = require("../helpers/mod.js");
...
exports.routes = {
    ...
    CHANNEL_MESSAGES: (channelId, options) => {
        ...
        if (options) {
            if ((0, mod_js_1.isGetMessagesAfter)(options) && options.after)
                url += `after=${options.after}`;
            if ((0, mod_js_1.isGetMessagesBefore)(options) && options.before)
                url += `&before=${options.before}`;
            if ((0, mod_js_1.isGetMessagesAround)(options) && options.around)
                url += `&around=${options.around}`;
            if ((0, mod_js_1.isGetMessagesLimit)(options) && options.limit)

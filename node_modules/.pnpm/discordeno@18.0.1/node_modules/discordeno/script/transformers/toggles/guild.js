...
class GuildToggles extends ToggleBitfield_js_1.ToggleBitfieldBigint {
    constructor(guildOrTogglesBigint) {
        ...
        if (typeof guildOrTogglesBigint == "bigint")
            ...
            if (guild.features.includes(shared_js_1.GuildFeatures.DeveloperSupportServer))
                this.add(exports.GuildToggle.developerSupportServer);
            if (guild.features.includes(shared_js_1.GuildFeatures.AnimatedBanner))
                this.add(exports.GuildToggle.animatedBanner);
            ...
            if (guild.features.includes(shared_js_1.GuildFeatures.Featurable))
                this.add(exports.GuildToggle.featurable);
            ...
            if (guild.features.includes(shared_js_1.GuildFeatures.AutoModeration))
                this.add(exports.GuildToggle.autoModeration);
            if (guild.features.includes(shared_js_1.GuildFeatures.InvitesDisabled))
                this.add(exports.GuildToggle.invitesDisabled);
        }
    }
    get features() {
        const features = [];
        for (const key of Object.keys(exports.GuildToggle)) {
            if (!featureNames.includes(key))
                continue;
            if (!super.contains(exports.GuildToggle[key]))
                continue;
            features.push(key);
        }
        return features;

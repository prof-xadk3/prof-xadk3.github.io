 ...
 */
export async function createGuildTemplate(bot, guildId, options) {
    ...
    const result = await bot.rest.runMethod(bot.rest, "POST", bot.constants.routes.GUILD_TEMPLATES(guildId), options);

 ...
 */
export async function upsertGlobalApplicationCommands(bot, commands) {
    const results = await bot.rest.runMethod(bot.rest, "PUT", bot.constants.routes.COMMANDS(bot.applicationId), commands.map((command) => bot.transformers.reverse.createApplicationCommand(bot, command)));

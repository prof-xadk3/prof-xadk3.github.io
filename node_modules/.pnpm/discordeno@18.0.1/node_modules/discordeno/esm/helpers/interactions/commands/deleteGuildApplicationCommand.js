 ...
 */
export async function deleteGuildApplicationCommand(bot, commandId, guildId) {
    return await bot.rest.runMethod(bot.rest, "DELETE", bot.constants.routes.COMMANDS_GUILD_ID(bot.applicationId, guildId, commandId));
}

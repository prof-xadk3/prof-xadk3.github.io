 ...
 */
export async function getMessage(bot, channelId, messageId) {
    const result = await bot.rest.runMethod(bot.rest, "GET", bot.constants.routes.CHANNEL_MESSAGE(channelId, messageId));

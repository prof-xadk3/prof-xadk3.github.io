 ...
 */
export async function deleteOwnReaction(bot, channelId, messageId, reaction) {
 ...
 */
export async function deleteUserReaction(bot, channelId, messageId, userId, reaction) {
    reaction = processReactionString(reaction);

 ...
 */
export async function getThreadMember(bot, channelId, userId) {
    const result = await bot.rest.runMethod(bot.rest, "GET", bot.constants.routes.THREAD_USER(channelId, userId));

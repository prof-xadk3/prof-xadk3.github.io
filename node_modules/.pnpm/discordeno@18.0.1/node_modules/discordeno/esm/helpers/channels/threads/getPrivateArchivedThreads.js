 ...
 */
export async function getPrivateArchivedThreads(bot, channelId, options) {
    const results = await bot.rest.runMethod(bot.rest, "GET", bot.constants.routes.THREAD_ARCHIVED_PRIVATE(channelId, options));
    return {

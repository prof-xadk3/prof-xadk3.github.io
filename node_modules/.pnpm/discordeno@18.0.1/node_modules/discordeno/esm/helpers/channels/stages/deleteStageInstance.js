 ...
 */
export async function deleteStageInstance(bot, channelId, reason) {
    return await bot.rest.runMethod(bot.rest, "DELETE", bot.constants.routes.STAGE_INSTANCE(channelId), reason ? { reason } : undefined);
}

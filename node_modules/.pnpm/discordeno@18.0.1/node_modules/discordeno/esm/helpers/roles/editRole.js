 ...
 */
export async function editRole(bot, guildId, roleId, options) {
    const result = await bot.rest.runMethod(bot.rest, "PATCH", bot.constants.routes.GUILD_ROLE(guildId, roleId), {
        name: options.name,
        color: options.color,
        hoist: options.hoist,

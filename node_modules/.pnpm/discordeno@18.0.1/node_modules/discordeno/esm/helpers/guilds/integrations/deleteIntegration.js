 ...
 */
export async function deleteIntegration(bot, guildId, integrationId) {
    return await bot.rest.runMethod(bot.rest, "DELETE", bot.constants.routes.GUILD_INTEGRATION(guildId, integrationId));
}

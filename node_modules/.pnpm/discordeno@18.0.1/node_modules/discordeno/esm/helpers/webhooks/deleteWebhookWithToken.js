 ...
 */
export async function deleteWebhookWithToken(bot, webhookId, token) {
    return await bot.rest.runMethod(bot.rest, "DELETE", bot.constants.routes.WEBHOOK(webhookId, token));
}

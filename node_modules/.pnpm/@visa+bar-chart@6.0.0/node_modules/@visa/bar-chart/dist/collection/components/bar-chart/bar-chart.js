...
export class BarChart {
  ...
  setXAxisAccessibility() {
    ...
    setAccessXAxis({
      ...
      hasXAxis: !this.checkHideAxisState('xAxis', 'horizontal', min(this.preppedData, d => d[this.valueAccessor])),
  ...
  setYAxisAccessibility() {
    ...
    setAccessYAxis({
      rootEle: this.barChartEl,
      hasYAxis: !this.checkHideAxisState('yAxis', 'vertical', min(this.preppedData, d => d[this.valueAccessor])),

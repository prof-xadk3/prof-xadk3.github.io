...
exports.AmethystEventHandler = void 0;
const mod_js_1 = require("../../mod.js");
/* It's a class that can be used to handle events. */
class AmethystEventHandler {
    constructor(client) {
        ...
        this.client = client;
        this.events = new mod_js_1.AmethystCollection();
...
exports.AmethystEventHandler = AmethystEventHandler;

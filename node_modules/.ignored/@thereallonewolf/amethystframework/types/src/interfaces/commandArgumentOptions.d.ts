import { ApplicationCommandOptionChoice, ApplicationCommandOptionTypes, Attachment, Channel, ChannelTypes, Interaction, InteractionDataOption, Locales, Member, Message, Role, User } from '../../deps.js';
...
export interface commandOption {
    ...
    description?: string;
    /**The option type*/
    type: Omit<ApplicationCommandOptionTypes, "SubCommand" | "SubCommandGroup"> | keyof Omit<typeof ApplicationCommandOptionTypes, "SubCommand" | "SubCommandGroup">;
...
export interface optionResults {
    ...
    getMentionable(name: string, required?: false): Promise<Role | User | undefined>;

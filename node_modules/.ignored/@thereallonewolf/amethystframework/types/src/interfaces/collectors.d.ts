import { Emoji, Interaction, Message } from "../../deps.js";
import { AmethystBot } from "../../mod.js";
...
export interface CollectComponentsOptions extends Omit<BaseCollectorCreateOptions, "key"> {
    key: bigint;
    filter: (bot: AmethystBot, data: Interaction) => boolean;
}
export interface CollectReactionsOptions extends Omit<BaseCollectorCreateOptions, "key"> {
    key: bigint;
    filter: (bot: AmethystBot, payload: {
        messageId: bigint;
        channelId: bigint;
        guildId?: bigint;
        userId: bigint;
...
export interface ReactionCollector extends CollectReactionsOptions {
    resolve: (value: AmethystReaction[] | PromiseLike<AmethystReaction[]>) => void;

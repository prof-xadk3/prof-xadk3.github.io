...
/*module.append(QRCode.toDataURL(process.argv[1], { errorCorrectionLevel: 'H' }, function(err, payload) {
  console.log(payload);
}));*/
// let modules = message.qrcode.modules;

const PAYLOAD = new QRCode(process.argv[1]);
var modules = PAYLOAD.qrcode.modules;
var ascii = '';
